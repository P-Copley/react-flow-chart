...
export type IOnDragCanvas = (input: {
  config?: IConfig;
  event: any;
  data: DraggableData;
}) => void;

export type IOnPortPositionChange = (input: {
  config?: IConfig;
  node: INode;
  port: IPort;
  el: HTMLDivElement;
...
export type IOnLinkMouseEnter = (input: {
  config?: IConfig;
  linkId: string;
}) => void;

export type IOnLinkMouseLeave = (input: {
  config?: IConfig;
  linkId: string;
}) => void;

export type IOnLinkClick = (input: {
  config?: IConfig;
  linkId: string;
}) => void;
...
export type IOnNodeClick = (input: {
  config?: IConfig;
  nodeId: string;
}) => void;

export type IOnNodeSizeChange = (input: {
  config?: IConfig;
  nodeId: string;
  size: ISize;
}) => void;

export type IOnCanvasDrop = (input: {
  config?: IConfig;
  data: any;
  position: IPosition;
}) => void;
